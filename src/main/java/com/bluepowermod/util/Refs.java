...
public class Refs {
    ...
    public static final String GRAVELSLAB_NAME = "gravel_slab";
    public static final String SANDSLAB_NAME = "sand_slab";
    public static final String DOUBLEGRAVELSLAB_NAME = "double_gravel_slab";
    public static final String DOUBLESANDSLAB_NAME = "double_sand_slab";
